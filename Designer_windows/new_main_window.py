...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1350, 640)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Maximum)
        sizePolicy.setHorizontalStretch(52)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(1350, 638))
        MainWindow.setMaximumSize(QtCore.QSize(1350, 640))
        ...
        self.frame.setGeometry(QtCore.QRect(20, 30, 391, 581))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btn_save_filter = QtWidgets.QPushButton(parent=self.frame)
        self.btn_save_filter.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_save_filter.sizePolicy().hasHeightForWidth())
        self.btn_save_filter.setSizePolicy(sizePolicy)
        self.btn_save_filter.setStyleSheet("QPushButton{\n"
                                           "color:white;\n"
                                           "background-color: rgba(255,255,255,30);\n"
                                           "border:1px solid rgba(255,255,255,40);\n"
                                           "border-radius: 7px;\n"
                                           ...
                                           "background-color:rgba(255,255,255,70);\n"
                                           "}")
        self.btn_save_filter.setObjectName("btn_exit")
        self.verticalLayout.addWidget(self.btn_save_filter)
        ...
        self.tableWidget.setGeometry(QtCore.QRect(420, 40, 900, 562))
        ...
        MainWindow.setTabOrder(self.btn_save_filter, self.btn_save_filter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_save_filter.setText(_translate("MainWindow", "Сохранить результат фильтра в файл"))
